...
work_dir = "/root/autodl-tmp/logs/redet_re101_refpn_1x_dota_ship_le90"
...
model = dict(
    ...
    backbone=dict(
        ...
        style='pytorch',
        # with_cp=True,
        pretrained='/root/autodl-tmp/code/mmrotate/configs/redet/pretrain/re_resnet101_v2_c8_batch256-f248cc41.pth'),
    neck=dict(
        type='ReFPN',
